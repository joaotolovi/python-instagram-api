...
@dataclass
class SharedArrayBufferTransferIssueDetails:
    '''
    Details for a request that has been blocked with the BLOCKED_BY_RESPONSE
    code. Currently only used for COEP/COOP, but may be extended to include
    some CSP errors in the future.
...
class InspectorIssueCode(enum.Enum):
    ...
    SHARED_ARRAY_BUFFER_TRANSFER_ISSUE = "SharedArrayBufferTransferIssue"
...
class InspectorIssueDetails:
    ...
    shared_array_buffer_transfer_issue_details: typing.Optional[SharedArrayBufferTransferIssueDetails] = None
    ...
    def to_json(self):
        ...
        if self.shared_array_buffer_transfer_issue_details is not None:
            json['sharedArrayBufferTransferIssueDetails'] = self.shared_array_buffer_transfer_issue_details.to_json()
        return json
    ...
    def from_json(cls, json):
        return cls(
            ...
            shared_array_buffer_transfer_issue_details=SharedArrayBufferTransferIssueDetails.from_json(json['sharedArrayBufferTransferIssueDetails']) if 'sharedArrayBufferTransferIssueDetails' in json else None,
        )
